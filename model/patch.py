...
from model.attention import RotaryEmbeddingESM, mukv_attention_forward
...
def patch_hf(
    ...
    **kwargs
    ...
    forward = huggingface_forward(mukv_attention_forward(**attn_kwargs))
